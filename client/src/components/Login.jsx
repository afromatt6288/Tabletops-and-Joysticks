              ...
              {/* <!-- Top Row container--> */}
                <div className="md:mx-2 md:p-12">
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="mt-1 my-2 pb-1 text-2xl font-semibold" style={{ background: "linear-gradient(to right, #d70ad3, #d00dd6, #c910d9, #bc14da, #b019db, #a41edc, #9823dd, #8c28de, #7f32df, #6b3fd9, #5346d9, #3d50d6, #2b59d1)"}}>Tabletops & Joysticks</h4>
                  </div>
                  {newUser ? ( <UserNew onNewUser={handleNewUser} toggle={toggle} /> 
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      {/* <!--Submit button--> */}
                      {invalidUser ? <small>Invalid User</small> : <small>Welcome</small>}
