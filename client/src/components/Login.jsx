            ...
            <div>
              {/* <!-- Top Row container--> */}
                <div className="md:mx-2 md:p-12">
                  ...
                  {newUser ? ( <UserNew onNewUser={handleNewUser} toggle={toggle} theme={theme} /> 
                  ) : (
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="mb-12 pb-1 pt-1 text-center">
                        <button type="submit" data-te-ripple-init data-te-ripple-color="light"
                          ...
                          className="bg-[var(--color-theme-background)!important] mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]"
                        > 
                          <label style={{ fontSize: 'max(1.3vw, 1em)'}}
