...
//white
    if (currentUser) {
        return (
            <div className="text-[var(--color-theme-text)!important] border-[var(--color-theme-border)!important] hover:text-[var(--color-theme-hover-text)!important] hover:border-[var(--color-theme-hover-border)!important] border-4 rounded-lg mx-auto w-3/4">
                <div id="accordionExample" className="">
                    <div className="bg-gray-600 bg-opacity-70 dark:border-neutral-600 dark:bg-neutral-800">
                        <h2 className="accordion-header mb-0" id="headingOne">
                            ...
                            >
                                <span className="flex mx-auto mr-6">
