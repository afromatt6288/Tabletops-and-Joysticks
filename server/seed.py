...
##########################################################
    ...
    # avatar_blob="TBD", 
    stars=3, travel_distance=5, theme="purple", is_active = False, is_admin=True)
    ...
    # avatar_blob="TBD", 
    stars=5, travel_distance=25, theme="purple", is_active = False, is_admin=True)
    ...
    # avatar_blob="TBD", 
    stars=3, travel_distance=5, theme="purple", is_active = False, is_admin=False)
    ...
    for n in range(20):
        ...
        new_user = User(username=username, email=fake.email(), address=fake.address(), avatar_url='https://cdn-icons-png.flaticon.com/512/8053/8053055.png', 
            # avatar_blob="TBD", 
            stars=randint(1,5), theme=rc(themes), travel_distance=5, is_active = False, is_admin=False)
...
##########################################################
    ...
    games = [
        ...
        Game(title='Escape Room: The Game 2', type='Board Games', genres='Puzzle, Cooperative', platforms='Tabletop', player_num_min=2, player_num_max=5, image_url='https://example.com/escape-room-the-game-2.jpg', description='Escape Room: The Game 2 is a board game where players work together to solve puzzles and escape from a series of themed rooms before time runs out.'),
        Game(title='Clank!', type='Deck Building Games', genres='Adventure, Fantasy', platforms='Tabletop', player_num_min=2, player_num_max=4, image_url='https://example.com/clank.jpg', description='In Clank!, players delve into a dungeon to steal treasure and avoid detection by a dragon.'),
        ...
        Game(title="The Quacks of Quedlinburg", type="Board Games", genres="Push Your Luck, Bag Building", platforms="Tabletop", player_num_min=2, player_num_max=4, image_url="https://example.com/quacks-of-quedlinburg.jpg", description="The Quacks of Quedlinburg is a game about alchemists trying to brew the most powerful potions, by drawing random ingredients from their own bags."),
        Game(title="Specter Ops", type="Board Games", genres="Deduction, Stealth", platforms="Tabletop", player_num_min=2, player_num_max=5, image_url="https://example.com/zombie-dice.jpg", description="Specter Ops is a tactical board game of hidden movement and deduction."),
        Game(title="Tales of the Arabian Nights", type="Board Games", genres="Adventure, Storytelling", platforms="Tabletop", player_num_min=1, player_num_max=6, image_url="https://example.com/zombie-dice.jpg", description="Tales of the Arabian Nights is an adventure game where players embark on a journey through a mystical world, making choices that determine their fate."),
        Game(title="Takenoko", type="Board Games", genres="Family, Strategy", platforms="Tabletop", player_num_min=2, player_num_max=4, image_url="https://example.com/zombie-dice.jpg", description="Takenoko is a cute and colorful game where players cultivate a bamboo garden and tend to a hungry panda."),
        Game(title="Time's Up!", type="Party Games", genres="Word", platforms="Tabletop", player_num_min=4, player_num_max=12, image_url="https://example.com/zombie-dice.jpg", description="Time's Up! is a fast-paced word-guessing game that will have you laughing and shouting with your friends."),
        Game(title="Tiny Epic Galaxies", type="Board Games", genres="Dice Rolling, Strategy", platforms="Tabletop", player_num_min=1, player_num_max=5, image_url="https://example.com/zombie-dice.jpg", description="Tiny Epic Galaxies is a compact strategy game where players compete to build the greatest galactic empire."),
        Game(title="Tokaido", type="Board Games", genres="Family, Strategy", platforms="Tabletop", player_num_min=2, player_num_max=5, image_url="https://example.com/zombie-dice.jpg", description="Tokaido is a peaceful journey through Japan where players collect experiences and meet new people along the way."),
        Game(title="Ultimate Werewolf", type="Party Games", genres="Social Deduction", platforms="Tabletop", player_num_min=5, player_num_max=68, image_url="https://example.com/zombie-dice.jpg", description="Ultimate Werewolf is a classic social deduction game where players work to identify the werewolf among them."),
        Game(title="Unstable Unicorns", type="Card Games", genres="Family, Strategy", platforms="Tabletop", player_num_min=2, player_num_max=8, image_url="https://example.com/zombie-dice.jpg", description="Unstable Unicorns is a whimsical card game where players collect and protect a menagerie of magical unicorns."),
        Game(title="Valley of the Kings", type="Card Games", genres="Deck Building", platforms="Tabletop", player_num_min=2, player_num_max=4, image_url="https://example.com/zombie-dice.jpg", description="Valley of the Kings is a deck-building game where players compete to build the most impressive tomb and earn the favor of the Pharaoh."),
        Game(title="Villages of Valeria", type="Card Games", genres="City-building, Resource Management", platforms="Tabletop", player_num_min=1, player_num_max=5, image_url="https://example.com/zombie-dice.jpg", description="Villages of Valeria is a strategic card game where players compete to build the most prosperous village in the land."),
